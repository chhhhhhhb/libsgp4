...
namespace libsgp4
{
     ...
     * @param[in] debug_mode  false: print errors to stderr and return 1;
     *                        true:  throw TleException on error
     * @returns 0 on success, 1 on error
     * @exception TleException when debug_mode is true and a format error is detected
     */
    int Tle::Initialize(bool debug_mode)
    {
        if (!IsValidLineLength(line_one_))
        {
            ...
            std::cerr << "TLE Error: Invalid length for line one" << std::endl;
            return 1;
        }
        ...
        if (!IsValidLineLength(line_two_))
        {
            ...
            std::cerr << "TLE Error: Invalid length for line two" << std::endl;
            return 1;
        }
        ...
        if (line_one_[0] != '1')
        {
            ...
            std::cerr << "TLE Error: Invalid line beginning for line one" << std::endl;
            return 1;
        }
        ...
        if (line_two_[0] != '2')
        {
            ...
            std::cerr << "TLE Error: Invalid line beginning for line two" << std::endl;
            return 1;
        }
        ...
        if (sat_number_1 != sat_number_2)
        {
            ...
            std::cerr << "TLE Error: Satellite numbers do not match" << std::endl;
            return 1;
        }
